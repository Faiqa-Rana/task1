...
//   const [showSignup, setShowSignup] = useState(true);  // Add state to toggle visibility
...
//   const closePage = () => {
//     setShowSignup(false);  // Hide the signup block
//   };

//   return (
//     <div>
//       {/* Only show the signup form when showSignup is true */}
//       {showSignup && (
